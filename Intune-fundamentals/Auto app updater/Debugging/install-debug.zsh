...
########################################### Parameters to modify #########################################################
		...
		if [[ $(arch) == "arm64" ]]; then
			items=( microsoftofficebusinesspro microsoftedge microsoftonedrive microsoftdefender microsoftcompanyportal zoom dropbox )
...
title="Welcome to a2o"
message="Please wait while applications are being downloaded and installed..."
endMessage="Installation complete! Custom apps will be installed later."
errorMessage="There was a problem during the installation. Please contact IT."
