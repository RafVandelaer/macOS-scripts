...
set_defaults() {
    ...
    appTitle="Lab9 Pro | App Auto-Patch" # MDM Enabled
    ...
    installomatorOptions="BLOCKING_PROCESS_ACTION=ignore NOTIFY=silent LOGO=appstore" # MDM Enabled
    ...
    supportTeamName="Lab9 pro" # MDM Enabled

    supportTeamPhone="011 92 22 00" # MDM Enabled

    supportTeamEmail="support.al@lab9pro.be" # MDM Enabled

    supportTeamWebsite="lab9pro.be" # MDM Enabled
