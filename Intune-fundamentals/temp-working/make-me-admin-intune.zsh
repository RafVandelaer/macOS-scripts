...
echo $currentUser
mkdir "/Library/Application\ Support/Lab9Pro" 
...
sudo defaults write /Library/LaunchDaemons/removeAdmin.plist ProgramArguments -array -string /bin/sh -string "/Library/Application\ Support/Lab9Pro/removeAdminRights.sh"
...
cat << 'EOF' > /Library/Application\ Support/Lab9Pro/removeAdminRights.sh
